...
insert into produto (id, nome, preco, descricao) values (3, 'Câmera GoPro Hero 7', 1400.0, 'Desempenho 2x');

insert into cliente (id, nome) values (1, 'Miguel Custodio Soares');
insert into cliente (id, nome) values (2, 'Leonardo Augusto dos Santos Soares');
